...
#check for a new FW version
#to be done
echo -e "${YELLOW}Check for a new RFLink FW${NC}"
curl -s 'http://127.0.0.1:8080/json.htm?type=command&param=addlogmessage&message=---%20RFLINK%20UPDATE%20---%20CHECK%20FOR%20NEW%20RFLINK%20FW'   > /dev/null
